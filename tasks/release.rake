...
### [v#{ENV['PRODUCT_VERSION']}](https://github.com/realityforge/graphql-java-scalars/tree/v#{ENV['PRODUCT_VERSION']}) (#{ENV['RELEASE_DATE']})
[Full Changelog](https://github.com/realityforge/graphql-java-scalars/compare/#{from}...v#{ENV['PRODUCT_VERSION']})
HEADER
